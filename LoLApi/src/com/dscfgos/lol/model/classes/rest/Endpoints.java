package com.dscfgos.lol.model.classes.rest;
...
public class Endpoints 
{
	...
	public static final String LEAGUE_MASTER                 	 = "/api/lol/{region}/v2.5/league/master";
	//static-data
	...
	public static final String SERVERS_STATUS                    = "/shards/{shard}";
	//match
	public static final String MATCH                             = "/api/lol/{region}/v2.2/match/{matchId}";
	
	//match list
	public static final String MATCH_LIST                        = "/api/lol/{region}/v2.2/matchlist/by-summoner/{summonerId}";
